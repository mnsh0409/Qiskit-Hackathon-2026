...
For the scalar overlap, yes — 4–6× cheaper and 27× more accurate on hardware; we say so on
the slide [R043, R044]. It returns one magnitude; only our arm returns the phase and the
per-observable breakdown [R042].
