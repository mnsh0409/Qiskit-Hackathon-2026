...
\begin{frame}{It survives on real hardware once the circuit is shallow enough}
  \begin{columns}[T]
    ...
    \begin{column}{0.39\textwidth}
      ...
      \par\smallskip
      \textbf{And a deeper test failed:} at $n{=}6$ a 576-gate AQC circuit returned
      \bad{0.026} survival against a pre-registered $0.315$ --- the compilation advantage
      does \emph{not} reach hardware yet. \src{R054}}
    \end{column}
  \end{columns}
\end{frame}
