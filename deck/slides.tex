...
\begin{frame}{Outline}
  ...
  \end{minipage}
  \vfill
  {\footnotesize\color{mutedA} Every number on these slides carries the
  \texttt{RESULTS.md} row that produced it, shown as \src{R0xx}.}
\end{frame}
...
\begin{frame}{The protocol, in the authors' own picture}
  \vspace{-1mm}
  \begin{center}
    \includegraphics[width=0.93\linewidth]{fig_paper_fig1.png}
  \end{center}
  \vspace{-1mm}
  {\footnotesize
...
\begin{frame}{What a classical shadow actually is}
  \vspace{-1mm}
  \begin{center}
    \includegraphics[width=0.97\linewidth]{fig_shadow.png}
  \end{center}
  \vspace{-1mm}
  {\footnotesize
