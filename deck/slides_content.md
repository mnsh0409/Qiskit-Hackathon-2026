...
**Speaker owners are TBD-C6** (roster + English comfort not supplied). Rotation
below assumes three speakers A/B/C; the rubric scores whether everyone speaks.
Timings: see `deck/script.md`.
...
- Team 8 — Garbage Collectors (fill TBD-NAME ×3 before export)
- figure: none (title)
- speaker: TBD-C6-A
...
- 2-gate echo beats our 136-gate arm 27× on hardware [R044]
- ⟨Q⟩_W−⟨Q⟩_U ≡ 0 by conservation ⇒ measured deviation is pure device error, no reference [R044]
- figures: deck/fig_tb_hardware.png · deck/fig_tb_symmetry.png
- speaker: TBD-C6-C
...
## S16 — Reproduce it
- 50+ sourced rows; scripts reproduce every hardware number; bug log incl. retractions
- figure: deck/qr_slides.png
- speaker: TBD-C6-A

## S17 — Team (arc-10)
- TBD-NAME ×3 with who-built-what (must map to who spoke) — human fill before export
- figure: none
- speaker: all
