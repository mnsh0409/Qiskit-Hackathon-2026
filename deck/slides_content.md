...
## S16 — Reproduce it
- 62 sourced rows; scripts reproduce every hardware number; bug log incl. retractions
- figure: deck/qr_slides.png
- speaker: Tina Tien (block M5)

## S16b — Summary — what we contributed, and what we found (LAST main slide; leave up for Q&A)
- Built: 5 tracks, Track B completed [R042], baselines incl. our loss [R043], AQC crossover [R046, R052], 62-row ledger
