...
\begin{frame}{The result, up front}
  ...
  \begin{itemize}
    ...
    \item \good{First Track B on a QPU.} 116 circuits, four arms --- ours plus two
          ...
          same-hour. \src{R044}
    \item \bad{And the cheap baseline beat us --- on both devices.} Worst error against
          exact, over \texttt{marrakesh} \emph{and} \texttt{kingston}: 2-gate echo
          \good{0.043}, 16-gate Hilbert--Schmidt 0.101, our 136-gate arm \bad{1.188}.
          A $27\times$ gap. That is the headline, not a footnote. \src{R044}
