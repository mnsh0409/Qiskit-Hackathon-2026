...
% TODO(team): verify all arXiv ids / DOIs before submission -- especially the SQD/SKQD
% citations, which must be checked against the actual publications.
\bibitem{sqd} J. Robledo-Moreno \emph{et al.},
\emph{Chemistry beyond exact solvability on a quantum-centric supercomputer},
arXiv:2405.05068 (2024).

\bibitem{skqd} W. Kirby \emph{et al.},
\emph{Sample-based Krylov quantum diagonalization}, arXiv preprint (2025).
% TODO: confirm exact author list, title and identifier before submission.
